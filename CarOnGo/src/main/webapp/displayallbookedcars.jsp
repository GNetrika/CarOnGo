...
<body>
    ...
    <div class="grid">
        ...
        <% 
            List<Booking> cars = (List<Booking>) request.getAttribute("carlist");
        ...
        <div class="card">
            ...
            <div class="detail"><span class="label">Customer Name:</span> <%= c.getCname() %></div>
            <div class="detail"><span class="label">Phone number:</span> <%= c.getPhone() %></div>
            <div class="detail"><span class="label">FromDate:</span> <%= c.getFromDate() %></div>
            <div class="detail"><span class="label">ToDate:</span> <%= c.getToDate() %></div>
